                        ...
                        <div class="form-container mx-auto">
                            <% 
                                ...
                                if (idParam == null || idParam.isEmpty()) {
                                    out.println("<div class='alert alert-danger'>ID ruang tidak ditemukan. <a href='adminDashboard.jsp'>Kembali</a></div>");
                                } else {
                                    try {
                                        ...
                                        PreparedStatement pst = db.prepareStatement(
                                            ...
                                            "JOIN buildings b ON r.building_id = b.id WHERE r.id = ?"
                                        );
                                        pst.setInt(1, roomId);
                            ...
                            <form action="../RoomServlet" method="post">
                                ...
                                <div class="form-field mb-3">
                                    ...
                                    <select class="form-select" id="buildingId" name="buildingId" required>
                                        <%
                                            // Fetch buildings list for dropdown
                                        ...
                                        %>
                                        <option value="<%= buildings.getInt("id") %>" <%= selected %>><%= buildings.getString("name") %></option>
                                        <%
                                            }
                                            buildings.close();
                                        %>
                            ...
                            <% 
                                            ...
                                            out.println("<div class='alert alert-danger'>Data ruang tidak ditemukan. <a href='adminDashboard.jsp'>Kembali</a></div>");
                                        }
                                        db.disconnect();
